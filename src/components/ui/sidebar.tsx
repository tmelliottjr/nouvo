...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground flex h-7 w-7 min-w-7 items-center justify-center rounded-md p-0 outline-hidden transition-[transform,opacity] focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
